# Task solve the coroutine problem by putting tasks directly on schedule when they are created
# The loop will turn on the next task on schedule when being idle (awaiting the last result)
